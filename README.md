...
**Note**: Format d'intention JSON agnostique et générique. L'Agent 1 analyse la complexité réelle de chaque requête et décompose intelligemment en sous-intentions (1 si simple, 2-3+ si complexe).
