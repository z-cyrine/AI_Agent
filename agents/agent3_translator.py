...
Rôle: Transformation des services sélectionnés en ordres de service conformes TMF641
Technologie: LLM (Llama 3.3 70B via API) + Pydantic + schémas TMF Open API
"""
import json
import os
